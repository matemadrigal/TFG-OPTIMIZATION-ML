"""
Extractor de series de liquidez sistémica desde la API de FRED.
Descarga 4 indicadores de liquidez y genera CSVs individuales y consolidado.
"""
...
# Rutas de salida
DIR_RAW = os.path.join("data", "raw", "liquidity")
...
def crear_consolidado(diccionario_series, directorio):
    ...
    # Guardar
    ruta = os.path.join(directorio, "liquidity_daily.csv")
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*50}")
    print("Extracción de liquidez completada.")
