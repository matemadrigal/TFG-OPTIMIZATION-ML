"""
Extractor de series de riesgo y mercado desde la API de FRED.
Descarga 5 indicadores de riesgo y genera CSVs individuales y consolidado.
"""
...
# Rutas de salida
DIR_RAW = os.path.join("data", "raw", "risk")
...
def crear_consolidado(diccionario_series, directorio):
    ...
    # Guardar
    ruta = os.path.join(directorio, "risk_daily.csv")
...
if __name__ == "__main__":
    ...
    print(f"\n{'='*50}")
    print("Extracción de riesgo completada.")
